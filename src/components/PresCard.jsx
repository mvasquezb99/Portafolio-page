            ...
            <div className="w-full h-4/5">
                <section className="w-full h-full pr-0 flex items-center justify-center flex-col">
                    ...
                    <div className="h-10 w-96 mt-6 flex flex-row items-center justify-center">
                        ...
                        <a className=" w-32 h-4/5 p-3 text-xs bg-gradient-to-r from-blue-500 to-blue-300 rounded-3xl flex justify-center items-center shadow-lg hover:from-blue-300 hover:to-blue-500 transition-colors " href="">
                            Download my CV
                        </a>
                    </div>
                </section>
