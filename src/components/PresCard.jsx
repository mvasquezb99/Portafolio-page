            ...
            <div className="w-full h-4/5">
                <section className="w-full h-full pr-0 flex items-center justify-center flex-col">
                    ...
                    <div className="h-12 w-96 mt-6 flex flex-row items-center justify-center">
                        ...
                        <a className=" w-32 h-4/5 p-3 text-xs rounded-3xl flex justify-center items-center shadow-md text-blue-500 hover:text-white hover:bg-blue-500 hover:-translate-y-1 hover:shadow-emerald-800 border border-blue-500 transition ease-in-out delay-75 " href="">
                            Download my CV
                        </a>
                    </div>
                </section>
