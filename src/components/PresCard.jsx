        ...
        <main className=' h-screen w-100 ml-94 mr-94 flex flex-col items-center justify-center'>
            <div className="w-full h-96 flex flex-row max-w-6xl">
                <section className="w-1/2 h-full ml-10 p-5 pr-0 flex items-start justify-center flex-col">
                    ...
                    <div className="h-10 w-40 mt-2 flex flex-row pl-0.5">
                ...
                <p className=" w-1/2 h-full mr-10 p-5 pl-0 flex flex-col justify-center text-base">
                    Systems Engineering student at EAFIT University, passionate about software development, computer systems and leadership. Demonstrating teamwork skills, clearly and assertively communicating my ideas and encouraging the participation of all members when seeking a common goal.
                </p>
            </div>
        </main>
    )
