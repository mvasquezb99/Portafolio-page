...
function RoadMap(){
    return(
        <div className="w-full h-1/2 pt-16 flex flex-col items-center pl-4 pr-4">
            ...
            <div className="w-full h-64 mt-5 ml-4 mr-4 pl-5 pr-5 max-w-7xl">
                <div className="w-full h-full flex flex-row justify-center border-b border-gray-500">
                    <TimeStamp year={'2021'}/>
                    <TimeStamp year={'2022'}/>
