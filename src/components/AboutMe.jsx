    ...
    return (
        ...
        <section className="w-full h-full flex flex-row justify-center items-center">
            <article className="w-2/3 h-2/4 flex flex-row justify-center items-center">
                <div className="bg-transparent rounded-full w-80 h-80 personalContainer max-h-96 max-w-96 min-w-[310px]" />
                <div className="w-1/2 pl-8 h-2/3 min-w-[640px] max-w-[640px] max-h-[350px] ">
